...
\begin{defn}
  ...
  \end{equation}
  Sometimes we also write $B(x,r):=B_r(x)$. 
\end{defn}
...
\begin{defn}
  ...
  \begin{align}
    ...
    \forall y \in {\cal X},\ \
    \\ \nonumber
    &d_{\cal X}(x,y)<\delta \implies d_{\cal Y}(f(x),f(y))<\epsilon
  \end{align}
\end{defn}
...
\begin{defn}
  ...
  \begin{equation}
    ...
    \forall f\in{\cal F},\ \forall x,y\in E,\ \\
      &d_{\cal X}(x,y)<\delta \implies |f(x)-f(y)|<\epsilon.
    \end{array}
  \end{equation}
\end{defn}
...
\begin{exc}
  ...
  Denote by $\Omega\subset \mathbb{R}^m$ a bounded open convex set.
  ...
  \begin{equation}
    ...
    \right\}
  \end{equation}
  is totally bounded and equicontinuous,
  but not sequentially compact.
\end{exc}
