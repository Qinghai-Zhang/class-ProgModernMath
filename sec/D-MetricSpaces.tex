...
\begin{lem}
  ...
  and any finite open cover $\{U_1, \ldots, U_m\}$ of $K$, 
  there exists another open cover $\{V_1, \ldots, V_m\}$
  of $K$
...
\begin{defn}
  ...
  ${\cal U}:=\{U_i: i\in {\cal I}\}$
  iff for any $i\in{\cal I}$
  we have $\Supp(f_i)\subset U_j$ for some $j\in{\cal I}$.
\end{defn}
...
% LocalWords:  isometry bijective homeomorphic homeomorphism Baire
% LocalWords:  contractive invertible pseudometric Jacobian infimum
% LocalWords:  preimage codomain Homeomophisms isometries
