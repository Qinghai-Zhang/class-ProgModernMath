...
\begin{thm}[Implicit function theorem]
  ...
  \item $\mathbf{g}\in {\cal C}(U\times V)$;
  \item $\forall \mathbf{x}\in U$,
    $\mathbf{g}|_{\{\mathbf{x}\}\times V} \in {\cal C}^1(V)$; 
