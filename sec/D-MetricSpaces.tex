...
\begin{solution}
  ...
  \begin{center}
    \begin{tikzpicture}[yscale=4, xscale=8]
      ...
      \draw[blue, thick] (1/3, 1/2) -- (2/3, 1/2);
      % \draw [blue] (1/3,1/2) circle [radius=0.2pt];
      % \draw [blue] (2/3,1/2) circle [radius=0.2pt];

      \draw[blue, thick] (1/9, 1/4) -- (2/9, 1/4);
      \draw[blue, thick] (7/9, 3/4) -- (8/9, 3/4);
      % \draw [blue] (1/9,1/4) circle [radius=0.15pt];
      % \draw [blue] (2/9,1/4) circle [radius=0.15pt];
      % \draw [blue] (7/9,3/4) circle [radius=0.15pt];
      % \draw [blue] (8/9,3/4) circle [radius=0.15pt];

      % Labels
      \draw (0,0) node[below left] {$0$};
      \draw (1/3,0) node[below] {$\frac{1}{3}$};
      \draw (2/3,0) node[below] {$\frac{2}{3}$};
      \draw (1/9,0) node[below] {$\frac{1}{9}$};
      \draw (2/9,0) node[below] {$\frac{2}{9}$};
      \draw (7/9,0) node[below] {$\frac{7}{9}$};
      \draw (8/9,0) node[below] {$\frac{8}{9}$};
      \draw (0,1) node[left] {$1$};

      \draw (1,0) node[below right] {$1$};
      \draw (0,1/2) node[left] {$\frac{1}{2}$};
      \draw (0,1/4) node[left] {$\frac{1}{4}$};
      \draw (0,3/4) node[left] {$\frac{3}{4}$};
      % Cantor function jumps
      \draw[dotted] (1/3,1/2) -- (1/3,0);
      \draw[dotted] (2/3,1/2) -- (2/3,0);
      \draw[dotted] (1/9,1/4) -- (1/9,0);
      \draw[dotted] (2/9,1/4) -- (2/9,0);
      \draw[dotted] (7/9,3/4) -- (7/9,0);
      \draw[dotted] (8/9,3/4) -- (8/9,0);

      \draw[blue] (1/27,1/8) -- (2/27,1/8);
      \draw[blue] (7/27,3/8) -- (8/27,3/8);
      \draw[blue] (19/27,5/8) -- (20/27,5/8);
      \draw[blue] (25/27,7/8) -- (26/27,7/8);
      % \draw [blue] (1/27,1/8) circle [radius=0.1pt];
      % \draw [blue] (2/27,1/8) circle [radius=0.1pt];
      % \draw [blue] (7/27,3/8) circle [radius=0.1pt];
      % \draw [blue] (8/27,3/8) circle [radius=0.1pt];
      % \draw [blue] (19/27,5/8) circle [radius=0.1pt];
      % \draw [blue] (20/27,5/8) circle [radius=0.1pt];
      % \draw [blue] (25/27,7/8) circle [radius=0.1pt];
      % \draw [blue] (26/27,7/8) circle [radius=0.1pt];
      ...
      \draw[blue] (1/81,1/16) -- (2/81,1/16);
      \draw[blue] (7/81,3/16) -- (8/81,3/16);
      \draw[blue] (19/81,5/16) -- (20/81,5/16);
      \draw[blue] (25/81,7/16) -- (26/81,7/16);
      \draw[blue] (55/81,9/16) -- (56/81,9/16);
      \draw[blue] (61/81,11/16) -- (62/81,11/16);
      \draw[blue] (73/81,13/16) -- (74/81,13/16);
      \draw[blue] (79/81,15/16) -- (80/81,15/16);

      \draw[blue] (1/243,1/32) -- (2/243,1/32);
      \draw[blue] (7/243,3/32) -- (8/243,3/32);
      \draw[blue] (19/243,5/32) -- (20/243,5/32);
      \draw[blue] (25/243,7/32) -- (26/243,7/32);
      \draw[blue] (55/243,9/32) -- (56/243,9/32);
      \draw[blue] (61/243,11/32) -- (62/243,11/32);
      \draw[blue] (73/243,13/32) -- (74/243,13/32);
      \draw[blue] (79/243,15/32) -- (80/243,15/32);

      \draw[blue] (163/243,17/32) -- (164/243,17/32);
      \draw[blue] (169/243,19/32) -- (170/243,19/32);
      \draw[blue] (181/243,21/32) -- (182/243,21/32);
      \draw[blue] (187/243,23/32) -- (188/243,23/32);
      \draw[blue] (217/243,25/32) -- (218/243,25/32);
      \draw[blue] (223/243,27/32) -- (224/243,27/32);
      \draw[blue] (235/243,29/32) -- (236/243,29/32);
      \draw[blue] (241/243,31/32) -- (242/243,31/32);
    \end{tikzpicture}
  \end{center}
